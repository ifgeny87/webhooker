...
3. После старта приложение пишет информацию о среде запуска: OS (название и версия), ОЗУ, место на диске, рабочая папка, команда запуска, аргументы запуска, версия ноды, pid.
